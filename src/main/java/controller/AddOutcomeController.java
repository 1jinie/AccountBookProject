...
public class AddOutcomeController implements Controller {
    @Override
    public void execute(Scanner sc) {
        System.out.println("--- 지출 내역을 입력합니다 ---");
        ...
        try {
            ...
            AccountVO vo = new AccountVO(id, "지출", amount, description, category, date);
            list.add(vo);
